...
public class AndroidMeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BodyPartFragment bodyFregment = new BodyPartFragment();
        ...
        bodyFregment.setmImageIds(AndroidImageAssets.getBodies());
        bodyFregment.setmListIndex(1);
        ...
        fragmentManager.beginTransaction()
                .add(R.id.body_container, bodyFregment)
                .commit();
